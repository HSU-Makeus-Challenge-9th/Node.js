...
export const insertStore = async (data, region, category) => {
    try {
        ...
        throw new CustomError(500,ErrorCodes.DB_OPERATION_FAILED,'가게 생성 중 오류가 발생하였습니다.');
    }
};
...
export const getStoreById = async (storeId, client = prisma) => {
    try {
        ...
        console.error(error.stack);
        throw new CustomError(500,ErrorCodes.DB_OPERATION_FAILED,'가게 조회 중 오류가 발생하였습니다.');
    }
};
